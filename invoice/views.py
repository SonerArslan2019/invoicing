...
def dashboard(request):
    ...
    return render(request, 'invoice/dashboards.html', context)
...
def viewPDFInvoice(request, slug):
    ...
    # Get Client Settings
    p_settings = Settings.objects.get(clientName='stark industrie')
...
def companySettings(request):
    company = Settings.objects.get(clientName='stark industrie')
